...
> **Personal note:** On Windows I also had to restart my terminal (not just Claude Desktop) before `uv` was recognized on the PATH. If you get a "command not found" error, try opening a fresh terminal window first.
